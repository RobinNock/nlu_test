...
void wavheader_print(struct wav_header *header) {
    ...
    printf("header.data_id: %c%c%c%c\n", header->data_id[0], header->data_id[1], header->data_id[2],
           header->data_id[3]);
